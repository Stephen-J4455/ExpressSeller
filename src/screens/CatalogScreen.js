    ...
    >
        ...
        <ScrollView style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <View style={styles.form}>
              ...
              <Text style={styles.label}>Vendor/Brand (Optional)</Text>
              <View style={styles.inputContainer}>
                <Ionicons
                  name="business"
                  size={20}
              ...
              {categories.length === 0 ? (
                <Text
                  style={{ color: colors.muted, fontSize: 14, marginBottom: 8 }}
                >
              ...
              <Text style={styles.label}>Product Badges (Optional)</Text>
              <Text style={styles.hint}>
                Select promotional badges for your product
              </Text>
                  ...
                  return (
                    ...
                    >
                      <Ionicons
                        name={badge.icon}
                        size={20}
                        color={isSelected ? badge.color : colors.muted}
                      />
                      <Text
                        style={[
              ...
              <View style={styles.settingsRow}>
                <View style={styles.settingItem}>
                  ...
                  <Pressable
                    style={[
                      styles.toggle,
                      trackInventory && styles.toggleActive,
                    ]}
                ...
                <View style={styles.settingItem}>
                  ...
                  <Pressable
                    style={[
                      styles.toggle,
                      allowBackorder && styles.toggleActive,
                    ]}
          ...
          <View style={styles.actionSheetContainer}>
            ...
            >
              <View style={styles.actionSheetHeader}>
                ...
                <Text style={styles.actionSheetSubtitle}>Choose an action</Text>
              </View>
              ...
              >
                <Ionicons
                  ...
                  size={22}
                  color={
                    selectedProduct?.status === "active" ? "#F59E0B" : "#10B981"
                  }
                />
                <Text style={styles.actionSheetButtonText}>
                  {selectedProduct?.status === "active"
          ...
          <ScrollView style={styles.detailContent}>
            ...
            <View style={styles.detailSection}>
              <View style={styles.detailTitleRow}>
                <Text style={styles.detailTitle}>{viewingProduct?.title}</Text>
              ...
              <View style={styles.detailPriceRow}>
                ...
                {viewingProduct?.compare_at_price && (
                  <View>
                    <Text style={styles.detailPriceLabel}>Original Price</Text>
              ...
              {viewingProduct?.vendor && (
                <View style={styles.detailBlock}>
                  <Text style={styles.detailLabel}>Vendor/Brand</Text>
                  <Text style={styles.detailText}>{viewingProduct.vendor}</Text>
                </View>
              )}
              ...
              <View style={styles.detailBlock}>
                ...
                <View style={styles.detailSettingRow}>
                  <Text style={styles.detailSettingLabel}>Track Inventory</Text>
                  <Text style={styles.detailSettingValue}>
                    {viewingProduct?.track_inventory ? "Yes" : "No"}
                  </Text>
                </View>
                <View style={styles.detailSettingRow}>
                  <Text style={styles.detailSettingLabel}>Allow Backorder</Text>
                  <Text style={styles.detailSettingValue}>
      ...
      <View style={styles.filters}>
        {filters.map(({ key, label }) => (
          ...
          >
            <Text
              style={[styles.chipText, filter === key && styles.chipTextActive]}
            >
              {label}
            </Text>
          </Pressable>
